...
* [ ] 게임 플레이어는 컴퓨터가 생각하고 있는 3개의 숫자를 입력한다. => `Console` 이용
* [ ] 상대방의 역할은 컴퓨터가 한다.
    * [ ] 컴퓨터는 1에서 9까지 서로 다른 임의의 수 3개를 선택한다. => `Randoms` 이용
...
* [ ] 컴퓨터는 입력한 숫자에 대한 결과를 출력한다. => `ScoreBoard` 이용
* [ ] 게임 결과를 판단한다. => `Referee` 이용
    * [ ] 3자리 숫자중에 같은 수가 같은 자리에 있으면 스트라이크이다.
    * [ ] 3자리 숫자중에 다른 자리에 있으면 볼이다.
    * [ ] 3자리 숫자중에 같은 수가 전혀 없으면 포볼 또는 낫싱이란 힌트를 얻는다.
* [ ] 선택한 3개의 숫자를 모두 맞히면 게임이 종료된다.
* [ ] 게임이 종료한 후 다시 시작하거나 완전히 종료할 수 있다.
    * [ ] 1을 누르면 재시작
    * [ ] 2를 누르면 종료
* [ ] 사용자가 잘못된 값을 입력할 경우 [ERROR]로 시작하는 에러 메시지를 출력하고 게임을 계속 진행할 수 있어야 한다.
    * [ ] 숫자가 아닌 값을 입력한다. => [ERROR] 숫자를 입력해주세요.
    * [ ] 3자리수가 아닌 숫자를 입력한다. => [ERROR] 3자리의 숫자를 입력해주세요.
